...
if cluster_run: # Running on the cluster
    ...
    sys.stdout = open('./test_mcmh_script_output_1', 'w')
...
for i in [1]:
    ...
    network_filename1 = "test/ACASXU_experimental_v2a_1_9_output1_1.nnet"
    network_filename2 = "test/ACASXU_experimental_v2a_1_9_output2_1.nnet"


    output_property_file = "output_property_test1_1.txt"
    input_property_file = "input_property_test1_1.txt"
