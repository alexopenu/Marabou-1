...
if cluster_run: # Running on the cluster
    ...
    sys.stdout = open('./test_mcmh_script_output_layer4', 'w')
...
for i in [4,2,3,5,6,1]:
    ...
    network_filename1 = "test/ACASXU_experimental_v2a_1_9_output1_a_4.nnet"
    network_filename2 = "test/ACASXU_experimental_v2a_1_9_output2_a_4.nnet"


    output_property_file = "output_property_test1_a_4.txt"
    input_property_file = "input_property_test1_a_4.txt"
